...
class QuotesAddForm extends StatefulWidget {
  const QuotesAddForm({super.key});

  @override
  _QuotesAddFormState createState() => _QuotesAddFormState();
}

class _QuotesAddFormState extends State<QuotesAddForm> {
